...
try:
    from NanoVNA_UTN_Toolkit.ui.utils.menu.calibration_menu.save_calibration.save_calibration import show_calibration_warning, save_kit_dialog
    import logging, sys
except ImportError as e:  
    logging.error("Failed to import required modules: %s", e)
    logging.info("Please make sure you're running from the correct directory and all dependencies are installed.")
...
try:
    from NanoVNA_UTN_Toolkit.ui.utils.menu.calibration_menu.delete_calibration.delete_calibration import handle_all_kits_deleted, handle_deleted_current_kit
    import logging, sys
except ImportError as e:  
    logging.error("Failed to import required modules: %s", e)
    logging.info("Please make sure you're running from the correct directory and all dependencies are installed.")
