...
def edit_graphics_markers(self):
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.edit_graphics.edit_graphics_window import EditGraphics
...
def open_view(self):
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.view_edit.view_window import View
