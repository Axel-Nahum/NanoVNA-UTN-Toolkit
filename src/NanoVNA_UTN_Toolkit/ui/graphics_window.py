...
try:
    from NanoVNA_UTN_Toolkit.ui.graphics_windows.graphics_utils.graphics_utils import create_left_panel
    from NanoVNA_UTN_Toolkit.ui.graphics_windows.graphics_utils.graphics_utils import create_right_panel
except ImportError as e:
    logging.error("Failed to import required modules: %s", e)
    logging.info("Please make sure you're running from the correct directory and all dependencies are installed.")
    sys.exit(1)
...
try:
    from NanoVNA_UTN_Toolkit.ui.graphics_windows.graphics_utils.markers_utils import _clear_all_marker_fields
except ImportError as e:
    logging.error("Failed to import required modules: %s", e)
    logging.info("Please make sure you're running from the correct directory and all dependencies are installed.")
    sys.exit(1)
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------------ #
    ...
    def run_sweep(self):
        ...
        try:
            ...
            settings = QSettings(calibration_path, QSettings.Format.IniFormat)
