...
try:
    from src.NanoVNA_UTN_Toolkit.ui.utils.view_graphics.view_utils import create_tab1
    from src.NanoVNA_UTN_Toolkit.ui.utils.view_graphics.view_utils import create_tab2
