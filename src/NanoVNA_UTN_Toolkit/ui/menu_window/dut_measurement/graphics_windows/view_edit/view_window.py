...
try:
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.view_edit.view_graphics_utils.view_utils import create_tab1
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.view_edit.view_graphics_utils.view_utils import create_tab2
...
try:
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.graphics_utils.updates.graphics_update import recreate_single_plot
except ImportError as e:
    logging.error("Failed to import required modules: %s", e)
    logging.info("Please make sure you're running from the correct directory and all dependencies are installed.")
    sys.exit(1)
...
try:
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.graphics_utils.reset.sliders_cursors_reset import reset_sliders_and_markers_for_graph_change
except ImportError as e:
    logging.error("Failed to import required modules: %s", e)
    logging.info("Please make sure you're running from the correct directory and all dependencies are installed.")
    sys.exit(1)
...
try:
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.graphics_utils.updates.cursors_visibility import force_marker_visibility, force_marker_visibility_2
except ImportError as e:
    import logging, sys
    logging.error("Failed to import required modules: %s", e)
    logging.info("Please make sure you're running from the correct directory and all dependencies are installed.")
...
#------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def on_apply_clicked(self):
        from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.graphics_utils.graphics_utils import create_left_panel, create_right_panel
