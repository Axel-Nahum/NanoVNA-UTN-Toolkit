...
try:
    from NanoVNA_UTN_Toolkit.ui.menu_window.dut_measurement.graphics_windows.edit_graphics.edit_graphics_utils.edit_graphics_utils import create_edit_tab1, create_edit_tab2
